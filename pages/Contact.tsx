  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (activeTab === 'employer') {
        ...
        formData.append('domain', 'industrieelektriker-stellenangebote.de');
        formData.append('niche', 'Industrieelektriker');
          ...
          {activeTab === 'employer' && (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input id="emp-stellentitel" name="stellentitel" required value={employer.stellentitel} onChange={handleEmployerChange} className={inputClass} placeholder="z.B. Industrieelektriker (m/w/d)" />
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      <input id="ini-gewuenschterBeruf" name="gewuenschterBeruf" required value={initiative.gewuenschterBeruf} onChange={handleInitiativeChange} className={inputClass} placeholder="z.B. Industrieelektriker" />
                    </div>
                  </div>
